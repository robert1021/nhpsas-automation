...
class TrackingModule:
    ...
    def add_status_type_cancellation_of_licence(self, discontinuation_date: str, isGowling: bool):
        empty_field_coord = search_for_image(self.tracking_status_status_type_empty_field_img)
        ...
        time.sleep(0.25)
        pyautogui.click()
        cancellation_of_licence_coord = search_for_image(self.tracking_status_status_type_cancellation_of_licence_img)
        pyautogui.moveTo(cancellation_of_licence_coord)
        time.sleep(0.25)
        pyautogui.click()
        ok_btn = search_for_image(self.find_ok_btn_img)
        pyautogui.moveTo(ok_btn)
        ...
        pyautogui.moveTo(empty_field_coord)
        time.sleep(0.25)
        pyautogui.move(275, 0)
        time.sleep(0.25)
        pyautogui.click()
        time.sleep(0.25)
        pyautogui.move(105, 0)
        time.sleep(0.25)
        d2 = datetime.datetime.now()
        # Need to wait so at least 1 minute has gone by between start and end date
        while str(d1).split(" ")[1][:5] == str(d2).split(" ")[1][:5]:
        ...
        time.sleep(0.25)
        pyautogui.click()
        notes_coord = search_for_image(self.notes_img)
        pyautogui.moveTo(notes_coord)
        time.sleep(0.25)
        pyautogui.click()
        time.sleep(0.25)
        if isGowling:
